...
public class Delete extends javax.swing.JDialog {
    ...
    public Delete(java.awt.Frame parent, boolean modal, CallbackDelete cbDel) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Are You Sure Delete");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Delete dialog = new Delete(new javax.swing.JFrame(), true, null);
